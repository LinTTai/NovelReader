...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        //注册菜单
        bottomMenuView = LayoutInflater.from(this).inflate(R.layout.bottom_menu_popupwindow, null, false);
        ...
        topMenuView = LayoutInflater.from(this).inflate(R.layout.top_menu_popupwindow, null, false);
